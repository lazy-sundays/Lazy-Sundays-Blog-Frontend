    ...
    <footer className="bg-bgsecondary w-full h-full mx-auto p-4 md:py-4 mt-auto">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-4">
        <div className="flex items-center justify-between">
          <div className="flex flex-col text-center">
            <Link href="/" className="flex items-center mb-4 sm:mb-0">
              <span className="self-center text-md font-semibold whitespace-nowrap">
                the lazy sundays blog
              </span>
            </Link>
            <span className="italic text-sm font-sans">
              You are visitor{" "}
          ...
          <ul className="flex flex-wrap items-center justify-center mb-4 text-sm font-medium sm:mb-0">
            <li key={"/random-article"}>
              <a
                href={"/random-article"}
                className="ml-4 hover:underline hover:decoration-accentprimary hover:decoration-2 md:ml-6"
              >
                Random Article
              </a>
            </li>
        ...
        <span className="block text-xs text-center">
          ...
          <div className="mb-2">
            Lazy Sundays &copy; 2023-{new Date().getFullYear()}
          </div>
        </span>
      </div>
    </footer>
